...
function App() {
  //useState Hook is used to manage the state of the component
  //useCallback Hook is used to memoize the function so that it does not get recreated
  //useEffect Hook is used to perform side effects in the component
  //useRef Hook is used to directly access the DOM element without re-rendering the component
